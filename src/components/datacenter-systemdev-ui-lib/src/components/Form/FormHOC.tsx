...
import { WarningsType } from './formHelpers/formsHelper.tsx'
import setFieldData from "final-form-set-field-data";
import arrayMutators from 'final-form-arrays'
import { valueIsNotEmpty } from '../../helpers/conditionsHelpers.ts'

export interface IFormHOC extends Omit<FormProps, 'onSubmit'>{
  callbackSubmit: (values: object) => void,
  callbackHandlerConfirmSubmit?: (warnings: WarningsType, values: object) => void,
  callbackHandlerFormField?: (args:unknown, state:unknown, utils:unknown) => void,
